...
Clone and build:
git clone https://github.com/Dennis-Smith414/open-meshtastic-monitor.git
cd open-meshtastic-monitor
...
Map Screen
<img src="meshScreenShots/map.png" alt="Map View" width="700"/>
Debug Logging
