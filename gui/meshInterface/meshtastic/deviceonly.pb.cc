...
PositionLite::_table_ = {
  {
    ...
    // sfixed32 latitude_i = 1;
    {PROTOBUF_FIELD_OFFSET(PositionLite, _impl_.latitude_i_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kSFixed32)},
    // sfixed32 longitude_i = 2;
    {PROTOBUF_FIELD_OFFSET(PositionLite, _impl_.longitude_i_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kSFixed32)},
    // int32 altitude = 3;
    {PROTOBUF_FIELD_OFFSET(PositionLite, _impl_.altitude_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // fixed32 time = 4;
    {PROTOBUF_FIELD_OFFSET(PositionLite, _impl_.time_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFixed32)},
    // .meshtastic.Position.LocSource location_source = 5;
    {PROTOBUF_FIELD_OFFSET(PositionLite, _impl_.location_source_), _Internal::kHasBitsOffset + 4, 0,
...
PROTOBUF_NDEBUG_INLINE UserLite::Impl_::Impl_(
    ...
    const ::meshtastic::UserLite& from_msg)
...
UserLite::_table_ = {
  {
    ...
    // bytes macaddr = 1 [deprecated = true];
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.macaddr_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // string long_name = 2;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.long_name_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string short_name = 3;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.short_name_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // .meshtastic.HardwareModel hw_model = 4;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.hw_model_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // bool is_licensed = 5;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.is_licensed_), _Internal::kHasBitsOffset + 6, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // .meshtastic.Config.DeviceConfig.Role role = 6;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.role_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // bytes public_key = 7;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.public_key_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // optional bool is_unmessagable = 9;
    {PROTOBUF_FIELD_OFFSET(UserLite, _impl_.is_unmessagable_), _Internal::kHasBitsOffset + 7, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
  }},
  // no aux_entries
  {{
...
PROTOBUF_NDEBUG_INLINE NodeInfoLite::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::NodeInfoLite& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0} {}
...
NodeInfoLite::_table_ = {
  {
    ...
    // uint32 num = 1;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.num_), _Internal::kHasBitsOffset + 3, 0,
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // float snr = 4;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.snr_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFloat)},
    // fixed32 last_heard = 5;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.last_heard_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFixed32)},
    // .meshtastic.DeviceMetrics device_metrics = 6;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.device_metrics_), _Internal::kHasBitsOffset + 2, 2,
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 channel = 7;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.channel_), _Internal::kHasBitsOffset + 6, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // bool via_mqtt = 8;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.via_mqtt_), _Internal::kHasBitsOffset + 8, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // optional uint32 hops_away = 9;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.hops_away_), _Internal::kHasBitsOffset + 7, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // bool is_favorite = 10;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.is_favorite_), _Internal::kHasBitsOffset + 9, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // bool is_ignored = 11;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.is_ignored_), _Internal::kHasBitsOffset + 10, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // uint32 next_hop = 12;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.next_hop_), _Internal::kHasBitsOffset + 11, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // uint32 bitfield = 13;
    {PROTOBUF_FIELD_OFFSET(NodeInfoLite, _impl_.bitfield_), _Internal::kHasBitsOffset + 12, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
  }},
  {{
...
PROTOBUF_NDEBUG_INLINE DeviceState::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::DeviceState& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
DeviceState::_table_ = {
  {
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 version = 8;
    {PROTOBUF_FIELD_OFFSET(DeviceState, _impl_.version_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // bool no_save = 9 [deprecated = true];
    {PROTOBUF_FIELD_OFFSET(DeviceState, _impl_.no_save_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // bool did_gps_reset = 11 [deprecated = true];
    {PROTOBUF_FIELD_OFFSET(DeviceState, _impl_.did_gps_reset_), _Internal::kHasBitsOffset + 6, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // .meshtastic.MeshPacket rx_waypoint = 12;
...
PROTOBUF_NDEBUG_INLINE NodeDatabase::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::NodeDatabase& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
NodeDatabase::_table_ = {
  {
    ...
    // uint32 version = 1;
    {PROTOBUF_FIELD_OFFSET(NodeDatabase, _impl_.version_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // repeated .meshtastic.NodeInfoLite nodes = 2 [(.nanopb) = {
    {PROTOBUF_FIELD_OFFSET(NodeDatabase, _impl_.nodes_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
...
PROTOBUF_NDEBUG_INLINE ChannelFile::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::ChannelFile& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
ChannelFile::_table_ = {
  {
    ...
    // repeated .meshtastic.Channel channels = 1;
    {PROTOBUF_FIELD_OFFSET(ChannelFile, _impl_.channels_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 version = 2;
    {PROTOBUF_FIELD_OFFSET(ChannelFile, _impl_.version_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
  }},
  {{
...
PROTOBUF_NDEBUG_INLINE BackupPreferences::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::BackupPreferences& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0} {}
...
BackupPreferences::_table_ = {
  {
    ...
    // uint32 version = 1;
    {PROTOBUF_FIELD_OFFSET(BackupPreferences, _impl_.version_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // fixed32 timestamp = 2;
    {PROTOBUF_FIELD_OFFSET(BackupPreferences, _impl_.timestamp_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFixed32)},
    // .meshtastic.LocalConfig config = 3;
