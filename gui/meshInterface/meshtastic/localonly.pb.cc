...
PROTOBUF_NDEBUG_INLINE LocalConfig::Impl_::Impl_(
    ...
    const ::meshtastic::LocalConfig& from_msg)
...
LocalConfig::_table_ = {
  {
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 version = 8;
    {PROTOBUF_FIELD_OFFSET(LocalConfig, _impl_.version_), _Internal::kHasBitsOffset + 8, 0,
...
PROTOBUF_NDEBUG_INLINE LocalModuleConfig::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::LocalModuleConfig& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0} {}
...
LocalModuleConfig::_table_ = {
  {
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 version = 8;
    {PROTOBUF_FIELD_OFFSET(LocalModuleConfig, _impl_.version_), _Internal::kHasBitsOffset + 13, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // .meshtastic.ModuleConfig.AudioConfig audio = 9;
