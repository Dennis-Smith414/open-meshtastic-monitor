...
PROTOBUF_NDEBUG_INLINE ChannelSettings::Impl_::Impl_(
    ...
    const ::meshtastic::ChannelSettings& from_msg)
...
ChannelSettings::_table_ = {
  {
    ...
    // uint32 channel_num = 1 [deprecated = true];
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.channel_num_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // bytes psk = 2;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.psk_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
    // string name = 3;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.name_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // fixed32 id = 4;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.id_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFixed32)},
    // bool uplink_enabled = 5;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.uplink_enabled_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // bool downlink_enabled = 6;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.downlink_enabled_), _Internal::kHasBitsOffset + 6, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
    // .meshtastic.ModuleSettings module_settings = 7;
    {PROTOBUF_FIELD_OFFSET(ChannelSettings, _impl_.module_settings_), _Internal::kHasBitsOffset + 2, 0,
...
ModuleSettings::_table_ = {
  {
    ...
    // uint32 position_precision = 1;
    {PROTOBUF_FIELD_OFFSET(ModuleSettings, _impl_.position_precision_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // bool is_client_muted = 2;
    {PROTOBUF_FIELD_OFFSET(ModuleSettings, _impl_.is_client_muted_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kBool)},
  }},
  // no aux_entries
  {{
...
PROTOBUF_NDEBUG_INLINE Channel::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::meshtastic::Channel& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0} {}
...
Channel::_table_ = {
  {
    ...
    // int32 index = 1;
    {PROTOBUF_FIELD_OFFSET(Channel, _impl_.index_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // .meshtastic.ChannelSettings settings = 2;
    {PROTOBUF_FIELD_OFFSET(Channel, _impl_.settings_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // .meshtastic.Channel.Role role = 3;
    {PROTOBUF_FIELD_OFFSET(Channel, _impl_.role_), _Internal::kHasBitsOffset + 2, 0,
