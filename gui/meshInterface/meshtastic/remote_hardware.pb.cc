...
HardwareMessage::_table_ = {
  {
    ...
    // .meshtastic.HardwareMessage.Type type = 1;
    {PROTOBUF_FIELD_OFFSET(HardwareMessage, _impl_.type_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // uint64 gpio_mask = 2;
    {PROTOBUF_FIELD_OFFSET(HardwareMessage, _impl_.gpio_mask_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    // uint64 gpio_value = 3;
    {PROTOBUF_FIELD_OFFSET(HardwareMessage, _impl_.gpio_value_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
